...
\begin{titlepage}
  ...
  \HRule\\[1.5cm]
	...
	\textsc{\Large Tirocinio esterno in azienda}\\[0.5cm] % Main heading such as the name of your university/college
	\textsc{\large Presso Diennea}\\[1.5cm] % Main heading such as the name of your university/college
